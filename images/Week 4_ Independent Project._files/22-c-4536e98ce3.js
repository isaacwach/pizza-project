(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[22],{FNQM:function(e,t,n){"use strict"
...
Promise.all([n.e(2),n.e(3),n.e(6),n.e(19),n.e(112),n.e(4087)]).then(n.bind(null,"PrO8")).then(({default:t})=>{const n=document.createElement("div")
...
document.addEventListener("tinyRCE/initEquation",({detail:t})=>{Promise.all([n.e(0),n.e(9),n.e(4103)]).then(n.bind(null,"dIBj")).then(({default:n})=>{const o=new n(t.ed)
e.equationCB(o)}).catch(Object(A["b"])(q.t("Something went wrong loading the equation editor")))})
document.addEventListener("tinyRCE/initEquella",t=>{Promise.all([n.e(0),n.e(4212)]).then(n.bind(null,"IOhY")).then(({default:n})=>{n(t.detail.ed)
e.equellaCB()}).catch(Object(A["b"])(q.t("Something went wrong loading Equella")))})
...
//# sourceMappingURL=22-c-4536e98ce3.js.map